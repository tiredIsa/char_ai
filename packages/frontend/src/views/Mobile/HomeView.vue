...
<template>
  <div class="absolute top-0 left-0 w-full  backdrop-blur-[15px]"
    style=" height: calc(var(--safe-area-inset-top) + 48px); ">
    <div class="h-12 w-full flex flex-row px-3 items-center"
      style="margin-top: var(--safe-area-inset-top); background-color: rgba(9, 9, 11, .8);">
      <button>
    ...
    <div class="p-4 max-w-2xl w-full ">
      <div class="flex items-center space-x-2">
        <textarea ref="textarea" v-model="input" type="text"
          ...
          class="w-full px-4 py-2 rounded-2xl bg-zinc-800 text-white border border-zinc-700 focus:outline-none  resize-none "
